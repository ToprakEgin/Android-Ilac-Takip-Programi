...
public class GeceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.IlacEklemeFABGece);
    ...
    public void populateList() {
        Cursor cursor = myDb.getGeceRowsSaatler();
        ...
        ListView myList = (ListView) findViewById(R.id.listviewgece);
