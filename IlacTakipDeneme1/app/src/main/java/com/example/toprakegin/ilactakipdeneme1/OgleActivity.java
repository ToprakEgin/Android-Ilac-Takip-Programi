...
public class OgleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.IlacEklemeFABOgle);
    ...
    public void populateList() {
        Cursor cursor = myDb.getOgleRowsSaatler();
        ...
        ListView myList = (ListView) findViewById(R.id.listviewogle);
